...
def trainRouteClient():
    try:
        ...
        MainFile_path ="Training_Batch_Files\Main_File"
        AdditionalFile_path ="Training_Batch_Files\Additional_File"
...
def predictRouteClient():
    try:
        mainFilepat ="Prediction_Batch_Files\Main_File"
        additionalFilePath ="Prediction_Batch_Files\Additional_File"

        prediction_val = Predict_Validation(mainFilepat,additionalFilePath)
        prediction_val.prediction_validation()

        pred = Prediction(mainFilepat,additionalFilePath)
        path,json_predictions = pred.predict_from_model()
